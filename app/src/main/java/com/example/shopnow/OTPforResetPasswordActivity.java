...
import com.example.shopnow.Model.Users;
import com.example.shopnow.Prevalent.Prevalent;
import com.example.shopnow.ViewHolder.NewPasswordActivity;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(OTPforResetPasswordActivity.this, HomeActivity.class));
                            finish();
